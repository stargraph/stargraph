...
Package.onUse(function(api) {
  ...
  api.use(['twbs:bootstrap@3.3.5','accounts-password','accounts-base','fortawesome:fontawesome@4.4.0','iron:router@1.0.9','templating','jquery','underscore','sg:cytoscape']);
